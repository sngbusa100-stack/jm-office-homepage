    ...
    <div className="page-shell section narrow-page">
      ...
      <section aria-labelledby="consult-form">
        ...
        <ul>
          ...
          <li><strong>전송 방식:</strong> 입력하신 내용은 암호화된 연결(HTTPS)로 접수 서버에 전달되며, 접수번호가 부여되고 사무소의 업무용 알림 채널(텔레그램 메신저)로 통지됩니다.</li>
          ...
          <li><strong>보관·파기:</strong> 상담 처리 완료 후 지체 없이 파기합니다. 파기 시 성함·연락처·상담 내용은 삭제되며, 개인을 식별할 수 없는 통계 정보(상담 분야·접수일)만 남습니다.</li>
        </ul>
      </section>
